...
export default class HomeScreen extends Component{
    ...
    likedArticle = () => {
        const url = "http://localhost:5000/like-article"
        axios
          .post(url)
          .then(response => {
              this.getArticle();
                            ...
                            <View style = {styles.middleBottomContainer}>
                                ...
                                <View style = {styles.lowerBottomContainer}>
                                    <View style = {styles.iconButtonContainer}>
                                        ...
                                        <TouchableOpacity onpress = {this.unlikeArticle}>
                                            <Icon
                                                reverse
                                                name = {"cross"}
                                                type = {"entypo"}
                                    ...
                                    <View style = {styles.iconButtonContainer}>
                                        ...
                                        <TouchableOpacity style = {styles.button} onpress = {this.popularArticles}>
